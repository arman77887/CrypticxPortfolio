  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden">
      ...
      <section id="about" className="py-20 px-4 max-w-5xl mx-auto">
        <div className="bg-surface/80 border border-surface-border rounded-2xl p-8 backdrop-blur-md">
          ...
          <div className="text-gray-300 space-y-4 leading-relaxed">
            <p>
              {t(
                'Add your story here. This space represents the life journey, personal philosophy, and creative spirit of Aryan Islam Nirob.',
                'এখানে আপনার গল্প লিখুন। এই জায়গাটি Aryan Islam Nirobের জীবনের পথচলা এবং মেধার বহিপ্রকাশ ঘটায়।'
              )}
            </p>
          </div>
        </div>
      ...
      <footer className="border-t border-surface-border py-8 text-center text-xs text-gray-500">
        <p>© {new Date().getFullYear()} Aryan Islam Nirob (CrypticX). All rights reserved.</p>
      </footer>
    </main>
  );
}
